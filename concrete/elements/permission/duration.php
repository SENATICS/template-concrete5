...
<div class="form-group">
	...
	<div class="checkbox"><label><?php echo $form->checkbox('pdStartDateAllDayActivate', 1, $pdStartDateAllDay)?> <?php echo t("All Day")?></label></div>
</div>

<div class="form-group">
<?php echo $form->label('pdEndDate_activate', tc('End date', 'To'))?>
	<?php echo $dt->datetime('pdEndDate', $pdEndDate, true);?>
	<div class="checkbox"><label><?php echo $form->checkbox('pdEndDateAllDayActivate', 1, $pdEndDateAllDay)?> <?php echo t("All Day")?></label></div>
</div>
...
<div class="form-group">
	...
	<div class="radio"><label><?php echo $form->radio('pdRepeatPeriodMonthsRepeatBy', 'month', $pdRepeatPeriodMonthsRepeatBy)?> <?php echo t('Day of Month')?></label></div>
	<div class="radio"><label><?php echo $form->radio('pdRepeatPeriodMonthsRepeatBy', 'week', $pdRepeatPeriodMonthsRepeatBy)?> <?php echo t('Day of Week')?></label></div>
</div>
...
foreach(\Punic\Calendar::getSortedWeekdays('wide') as $weekDay) {
	?>
	<div class="checkbox"><label><input <?php if (in_array($weekDay['id'], $pdRepeatPeriodWeekDays)) { ?>checked="checked" <?php } ?>
	type="checkbox" name="pdRepeatPeriodWeeksDays[]" value="<?php echo $weekDay['id']?>" /> <?php echo h($weekDay['name'])?></label></div>
	<?php
} ?>
</div>
...
<div class="form-group">
	...
	<div class="radio"><label><?php echo $form->radio('pdEndRepeatDate', '', $pdEndRepeatDate)?> <?php echo t('Never')?></label></div>
    <div class="radio"><label><?php echo $form->radio('pdEndRepeatDate', 'date', $pdEndRepeatDate)?> <?php echo $dt->date('pdEndRepeatDateSpecific', $pdEndRepeatDateSpecific)?></label></div>
</div>
