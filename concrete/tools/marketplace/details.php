...
<?php } else {	
	...
	?>
		...
		<div class="dialog-buttons">
			<input type="button" class="btn btn-primary pull-right"  <?php if (!$mri->getMarketplaceItemVersionForThisSite()) { ?> disabled<?php } ?> value="<?php echo $buttonText?>" onclick="<?php echo $buttonAction?>" />
