...
?>
	...
	<?php	
		...
		<div class="ccm-theme-style-attribute <?php if ($useSlots) { ?>ccm-theme-style-slots<?php } ?>">
			...
			<?php echo $form->hidden('input_theme_style_' . $customST->getHandle() . '_' . $customST->getType(), htmlentities($customST->getOriginalValue(), ENT_QUOTES, APP_CHARSET))?>
    ...
    <?php echo $vt->output()?>
    <?php echo $form->hidden('saveAction', $view->action('save')); ?>
    <?php echo $form->hidden('resetAction', $view->action('reset')); ?>
    ...
    <div class="ccm-pane-footer">
    	<?php print $ih->button(t('Return to Themes'), $view->url('/dashboard/pages/themes'), 'left'); ?>
