...
<div id="ccm-tab-content-options" class="ccm-tab-content">
    <div class="row">
        <div class="col-lg-7">
            ...
            <div class="form-group">
                <div class="radio" style="display: inline-block; margin-right:30px;">
                    <label><input type="radio" name="<?php echo $view->field('navigationType'); ?>" value="0" <?php echo $navigationType > 0 ? '' : 'checked'; ?> />Mostrar</label>
                </div>
                <div class="radio" style="display: inline-block;">
                    <label><input type="radio" name="<?php echo $view->field('navigationType'); ?>" value="1" <?php echo $navigationType > 0 ? 'checked' : ''; ?> />Ocultar</label>
                </div>
            </div>
            <div class="form-group">
                <?php echo $form->checkbox('noAnimate', 1, $noAnimate); ?>
                <?php echo $form->label('noAnimate', t('Activar desplazamiento automático')); ?>
            </div>
            <div class="form-group">
                <?php echo $form->checkbox('infinite', 1, $infinite); ?>
                <?php echo $form->label('infinite', t('Carrusel Infinito')); ?>
            </div>
            <div class="form-group">
                <?php echo $form->checkbox('modo_center', 1, $modo_center); ?>
                <?php echo $form->label('modo_center', t('Modo Centrado')); ?>
            </div>
            <div class="form-group">
                <?php echo $form->checkbox('auto_height', 1, $auto_height); ?>
                <?php echo $form->label('auto_height', t('Ajustar la altura automáticamente')); ?>
            </div>
            <div class="form-group">
            <?php echo $form->label('maxWidth', t('Ancho de la diapositiva (0 es igual 100%)')); ?>
                <div class="input-group" style="width: 150px">
                <?php echo $form->number('maxWidth', $maxWidth ? $maxWidth : 0, array('min' => '0', 'max' => '1000'))?><span class="input-group-addon"><?php echo t('px'); ?></span>
                </div>
            </div>
        ...
        <div class="col-lg-5">
            ...
            <div class="form-group">
                <?php echo $form->label('slidesToShow', t('Cantidad de Ítems por diapositivas')); ?>
                <div class="input-group" style="width: 150px">
                <?php echo $form->number('slidesToShow', $slidesToShow ? $slidesToShow : 3, array('min' => '1', 'max' => '6'))?><span class="input-group-addon"><?php echo t('ítems'); ?></span>
                </div>
            </div>
            <div class="form-group">
                <?php echo $form->label('slidesToScroll', t('Entre cada diapositiva se va a saltar')); ?>
                <div class="input-group" style="width: 150px">
                <?php echo $form->number('slidesToScroll', $slidesToScroll ? $slidesToScroll : 3, array('min' => '1', 'max' => '6'))?><span class="input-group-addon"><?php echo t('ítems'); ?></span>
                </div>
            </div>
            <div class="form-group">
