(function () {
    ...
    window.C5GMaps = {
        ...
        setupAutocomplete: function () {
            ...
            var input = $("#ccm-mapas-block-location > input[id=location]").get(0),
                autocomplete = new google.maps.places.Autocomplete(input),
                note = $("#ccm-mapas-block-location > #block_note").get(0);
            ...
            google.maps.event.addListener(autocomplete, 'place_changed', function () {
                ...
                if (!place.geometry) {
                    ...
                    $('#ccm-mapas-block-location > input[id=latitude]').val(place.geometry.location.lat());
                    $('#ccm-mapas-block-location > input[id=longitude]').val(place.geometry.location.lng());
