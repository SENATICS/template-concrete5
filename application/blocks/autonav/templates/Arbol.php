...
<link rel="stylesheet" href="<?php echo BASE_URL?>/application/blocks/autonav/src/style.min.css" />
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js"></script>
<script src="<?php echo BASE_URL?>/application/blocks/autonav/src/jstree.min.js"></script>
...
foreach ($navItems as $ni) {
    ...
    echo '<a class="waves-effect waves-brow collection-item '. $ni->classes . '" href="' . $ni->url . '" target="' . $ni->target . '">' . $name . '</a>';
}
echo'</div>';
