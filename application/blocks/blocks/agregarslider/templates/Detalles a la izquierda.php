...
if ($c->isEditMode()) { ?>
    <div class="ccm-edit-mode-disabled-item" style="width: <?php echo $width; ?>; height: <?php echo $height; ?>">
        <div style="padding: 100px 20px"><?php echo t('Slider de Fotos en Modo de Edición')?></div>
    </div>
<?php  } else { ?>
...
<style>
    ...
    .col_descripcion{
        ...
        background: -moz-linear-gradient(left, rgba(0,0,0,0.77) 0%, rgba(13,13,13,0.77) 17%, rgba(76,76,76,0) 100%);
        background: -webkit-gradient(left top, right top, color-stop(0%, rgba(0,0,0,0.77)), color-stop(17%, rgba(13,13,13,0.77)), color-stop(100%, rgba(76,76,76,0)));
        background: -webkit-linear-gradient(left, rgba(0,0,0,0.77) 0%, rgba(13,13,13,0.77) 17%, rgba(76,76,76,0) 100%);
        background: -o-linear-gradient(left, rgba(0,0,0,0.77) 0%, rgba(13,13,13,0.77) 17%, rgba(76,76,76,0) 100%);
        background: -ms-linear-gradient(left, rgba(0,0,0,0.77) 0%, rgba(13,13,13,0.77) 17%, rgba(76,76,76,0) 100%);
        background: linear-gradient(to right, rgba(0,0,0,0.77) 0%, rgba(13,13,13,0.77) 17%, rgba(76,76,76,0) 100%);
