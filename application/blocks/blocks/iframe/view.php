	...
	'
		<div id="ventana'.$bID.'">
			<div class="ventana-contenido">
				...
				<div class="ventana">';
					if ($linkURL): print '<iframe id="'.$bID.'" src="'.$linkURL.'" style="width:100% !important" height="';
						if ($maxHeight == 0): print '450px;'; endif;
						if ($maxHeight > 0): print $maxHeight.'px'; endif;
					print'"></iframe>'; endif;
						if ($content): print '<div id="HTMLBlock'.$bID.'>" class="HTMLBlock" style="';
...
<?php if ($c->isEditMode()) { ?>
    <div class="ccm-edit-mode-disabled-item"><?php echo t('Bloque de Popup URL: #ventana'.$bID)?></div>
<?php } ?>