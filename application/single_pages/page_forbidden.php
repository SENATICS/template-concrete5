<html>
    ...
    <body class="fondo">
    	<center>
        	<div class="base">
            	<img src="<?php echo BASE_URL ?>/application/single_pages/Bloqueo.png" class="logo-construccion" /><br>
				<?php defined('C5_EXECUTE') or die("Access Denied."); ?>
                <span class="error-cuatrocientoscuatro">NO!</span>
                <h1 class="error" style="font-family:Arial, Helvetica, sans-serif">Página Prohibida</h1>
                <span>La página que estás buscando no está disponible para ti. </span>
